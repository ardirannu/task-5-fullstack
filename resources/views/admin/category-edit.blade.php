...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Form Edit Data Category</h4>
            <p class="card-description">
                Complete the form below to edit category data!
            </p>
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" class="form-control" id="exampleSelectGender">
                                ...
                                @foreach ($user as $data)
                                    <option value="{{ $data->id }}" @if($category->user_id == $data->id) selected @endif>{{ $data->name }}</option>    
                                @endforeach
                            </select>
                        </div>
                    </div>
